...
$_['entry_location']                   = 'Application Location';
...
$_['entry_tax_default']                = 'Use Application Tax Address';
...
// Help
$_['help_geocode']                     = 'Please enter your application location geocode manually.';
$_['help_open']                        = 'Fill in your application\'s opening times.';
$_['help_comment']                     = 'This field is for any special notes you would like to tell the customer i.e. Application does not accept cheques.';
$_['help_location']                    = 'The different application locations you have that you want displayed on the contact us form.';
$_['help_currency']                    = 'Change the default currency. Clear your browser cache to see the change and reset your existing cookie.';
$_['help_currency_auto']               = 'Set your application to automatically update currencies daily.';
...
$_['help_product_count']               = 'Show the number of products inside the subcategories in the applicationfront header category menu. Be warned, this will cause an extreme performance hit for applications with a lot of subcategories!';
...
$_['help_review_mail']                 = 'Send an email to the application owner when a new review is created.';
...
$_['help_tax_default']                 = 'Use the application address to calculate taxes if no one is logged in. You can choose to use the application address for the customer\'s shipping or payment address.';
...
$_['help_order_mail']                  = 'Send an email to the application owner when a new order is created.';
...
$_['help_affiliate_mail']              = 'Send an email to the application owner when a new affiliate is registered.';
...
$_['help_maintenance']                 = 'Prevents customers from browsing your application. They will instead see a maintenance message. If logged in as admin, you will see the application as normal.';
