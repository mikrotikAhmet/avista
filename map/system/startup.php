...
function modification($filename) {
    if (!defined('DIR_PORTAL')) {
        $file = DIR_MODIFICATION . 'portal/' . substr($filename, strlen(DIR_APPLICATION));
    } else {
        $file = DIR_MODIFICATION . 'map/' .  substr($filename, strlen(DIR_APPLICATION));
    }
