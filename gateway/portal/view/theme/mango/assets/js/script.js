...
(function($, mango, undefined){
	...
	requirejs.config({
		...
		baseUrl: 'view/theme/mango/assets/js/',
	...
	mango.register('forms', ['mylibs/forms/jquery.checkbox', 'mylibs/forms/jquery.chosen', 'mylibs/forms/jquery.fileinput', 'mylibs/forms/jquery.ellipsis', 'mylibs/forms/jquery.autosize', 'mylibs/forms/jquery.pwdmeter', 'mylibs/forms/jquery.maskedinput', 'mylibs/forms/uploader/plupload.full.min', 'mylibs/forms/uploader/jquery.plupload.queue/jquery.plupload.queue', 'mylibs/forms/jquery.colorpicker', 'mylibs/forms/jquery.cleditor'], {
		...
		func: function() {
			...
			$('input:checkbox').not('.ready').checkbox({
				cls : 'checkbox',
				empty : 'view/theme/mango/assets/img/elements/checkbox/empty.png'
			}).addClass('ready');
			...
			$('.uploader').not('.ready').each(function(){
				...
				$uploader.pluploadQueue($.extend({
					...
					flash_swf_url : 'view/theme/mango/assets/js/mylibs/forms/uploader/Movie.swf'
				}, $uploader.data()));
	...
	mango.ready(function(){
		...
		mango.utils.preload([
			'view/theme/mango/assets/img/layout/navigation/arrow-active.png',
			'view/theme/mango/assets/img/layout/navigation/arrow-hover.png',
			'view/theme/mango/assets/img/layout/navigation/arrow.png',
			'view/theme/mango/assets/img/layout/navigation/bg-current.png',
			'view/theme/mango/assets/img/layout/navigation/bg-active.png',
			'view/theme/mango/assets/img/layout/navigation/bg-hover.png',
			'view/theme/mango/assets/img/layout/navigation/bg-normal.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/layout/sidebar/bg-right.png',
			'view/theme/mango/assets/img/layout/sidebar/bg.png',
			'view/theme/mango/assets/img/layout/sidebar/divider.png',
			'view/theme/mango/assets/img/layout/sidebar/shadow-right.png',
			'view/theme/mango/assets/img/layout/sidebar/shadow.png',
			'view/theme/mango/assets/img/layout/sidebar-right/header-bg.png',
			'view/theme/mango/assets/img/layout/sidebar-right/nav-bg-hover.png',
			'view/theme/mango/assets/img/layout/sidebar-right/nav-bg.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/layout/toolbar/bg.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg-active.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg-disabled.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg-hover.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg-red-active.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg-red-disabled.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg-red-hover.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg-red.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/bg.png',
			'view/theme/mango/assets/img/layout/toolbar/buttons/divider.png'
		]);

		mango.utils.preload(['view/theme/mango/assets/img/layout/footer/divider.png']);


		mango.utils.preload([
			'view/theme/mango/assets/img/layout/bg.png',
			'view/theme/mango/assets/img/layout/content/box/actions-bg.png',
			'view/theme/mango/assets/img/layout/content/box/bg.png',
			'view/theme/mango/assets/img/layout/content/box/header-bg.png',
			'view/theme/mango/assets/img/layout/content/box/menu-active-bg.png',
			'view/theme/mango/assets/img/layout/content/box/menu-arrow.png',
			'view/theme/mango/assets/img/layout/content/box/menu-bg.png',
			'view/theme/mango/assets/img/layout/content/box/menu-item-bg-hover.png',
			'view/theme/mango/assets/img/layout/content/box/menu-item-bg.png',
			'view/theme/mango/assets/img/layout/content/box/tab-hover.png',
			'view/theme/mango/assets/img/layout/content/toolbar/bg-shortcuts.png',
			'view/theme/mango/assets/img/layout/content/toolbar/bg.png',
			'view/theme/mango/assets/img/layout/content/toolbar/divider.png',
			'view/theme/mango/assets/img/layout/content/toolbar/popup-arrow.png',
			'view/theme/mango/assets/img/layout/content/toolbar/popup-header.png',
			'view/theme/mango/assets/img/layout/content/toolbar/user/arrow-normal.png',
			'view/theme/mango/assets/img/layout/content/toolbar/user/avatar-bg.png',
			'view/theme/mango/assets/img/layout/content/toolbar/user/avatar.png',
			'view/theme/mango/assets/img/layout/content/toolbar/user/bg-hover.png',
			'view/theme/mango/assets/img/layout/content/toolbar/user/bg-menu-hover.png',
			'view/theme/mango/assets/img/layout/content/toolbar/user/counter.png'
		]);


		mango.utils.preload([
			'view/theme/mango/assets/img/elements/alert-boxes/bg-error.png',
			'view/theme/mango/assets/img/elements/alert-boxes/bg-information.png',
			'view/theme/mango/assets/img/elements/alert-boxes/bg-note.png',
			'view/theme/mango/assets/img/elements/alert-boxes/bg-success.png',
			'view/theme/mango/assets/img/elements/alert-boxes/bg-warning.png',
			'view/theme/mango/assets/img/elements/alert-boxes/error.png',
			'view/theme/mango/assets/img/elements/alert-boxes/information.png',
			'view/theme/mango/assets/img/elements/alert-boxes/note.png',
			'view/theme/mango/assets/img/elements/alert-boxes/success.png',
			'view/theme/mango/assets/img/elements/alert-boxes/warning.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/breadcrumb/bg-active.png',
			'view/theme/mango/assets/img/elements/breadcrumb/bg-hover.png',
			'view/theme/mango/assets/img/elements/breadcrumb/divider-active.png',
			'view/theme/mango/assets/img/elements/breadcrumb/divider-hover.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/headerbuttons/bg-active.png',
			'view/theme/mango/assets/img/elements/headerbuttons/bg-hover.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/autocomplete/el-bg-hover.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/calendar/arrow-hover-bg.png'
		]);

		mango.utils.preload(['view/theme/mango/assets/img/elements/charts/hover-bg.png']);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/messages/button-active-bg.png',
			'view/theme/mango/assets/img/elements/messages/button-hover-bg.png'
		]);
		...
		mango.utils.preload([
			'view/theme/mango/assets/img/elements/mail/actions-bg.png',
			'view/theme/mango/assets/img/elements/mail/button-bg-disabled.png',
			'view/theme/mango/assets/img/elements/mail/button-bg-hover.png',
			'view/theme/mango/assets/img/elements/mail/button-bg.png',
			'view/theme/mango/assets/img/elements/mail/button-red-bg-hover.png',
			'view/theme/mango/assets/img/elements/mail/button-red-bg.png',
			'view/theme/mango/assets/img/elements/mail/button-red-disabled.png',
			'view/theme/mango/assets/img/elements/mail/hover-bg.png',
			'view/theme/mango/assets/img/elements/mail/mail.png',
			'view/theme/mango/assets/img/elements/mail/text-arrow.png',
			'view/theme/mango/assets/img/elements/mail/text-bg.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/fullstats/list/hover-bg.png',
			'view/theme/mango/assets/img/elements/fullstats/simple/a-active.png',
			'view/theme/mango/assets/img/elements/fullstats/simple/a-hover.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/checkbox/checked-active.png',
			'view/theme/mango/assets/img/elements/checkbox/checked-disabled.png',
			'view/theme/mango/assets/img/elements/checkbox/checked-hover.png',
			'view/theme/mango/assets/img/elements/checkbox/checked-normal.png',
			'view/theme/mango/assets/img/elements/checkbox/unchecked-active.png',
			'view/theme/mango/assets/img/elements/checkbox/unchecked-disabled.png',
			'view/theme/mango/assets/img/elements/checkbox/unchecked-hover.png',
			'view/theme/mango/assets/img/elements/checkbox/unchecked-normal.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/radiobutton/checked-active.png',
			'view/theme/mango/assets/img/elements/radiobutton/checked-disabled.png',
			'view/theme/mango/assets/img/elements/radiobutton/checked-hover.png',
			'view/theme/mango/assets/img/elements/radiobutton/checked-normal.png',
			'view/theme/mango/assets/img/elements/radiobutton/unchecked-active.png',
			'view/theme/mango/assets/img/elements/radiobutton/unchecked-disabled.png',
			'view/theme/mango/assets/img/elements/radiobutton/unchecked-hover.png',
			'view/theme/mango/assets/img/elements/radiobutton/unchecked-normal.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/colorpicker/arrow.png',
			'view/theme/mango/assets/img/elements/colorpicker/bg.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/forms/icon-error.png',
			'view/theme/mango/assets/img/elements/forms/icon-success.png',
			'view/theme/mango/assets/img/elements/forms/tooltip-error-arrow.png',
			'view/theme/mango/assets/img/elements/forms/tooltip-error.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/profile/change-active-bg.png',
			'view/theme/mango/assets/img/elements/profile/change-hover-bg.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/search/arrow.png',
			'view/theme/mango/assets/img/elements/search/glass.png',
			'view/theme/mango/assets/img/elements/search/list-hover.png',
			'view/theme/mango/assets/img/elements/search/loading.gif'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/select/bg-active.png',
			'view/theme/mango/assets/img/elements/select/bg-hover.png',
			'view/theme/mango/assets/img/elements/select/bg-right-hover.png',
			'view/theme/mango/assets/img/elements/select/list-hover-bg.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/settings/header-bg.png',
			'view/theme/mango/assets/img/elements/settings/header-current-bg.png',
			'view/theme/mango/assets/img/elements/settings/header-hover-bg.png',
			'view/theme/mango/assets/img/elements/settings/seperator-current-left.png',
			'view/theme/mango/assets/img/elements/settings/seperator-current-right.png',
			'view/theme/mango/assets/img/elements/settings/seperator.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/slide-unlock/lock-slider.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/spinner/arrow-down-active.png',
			'view/theme/mango/assets/img/elements/spinner/arrow-down-hover.png',
			'view/theme/mango/assets/img/elements/spinner/arrow-up-active.png',
			'view/theme/mango/assets/img/elements/spinner/arrow-up-hover.png',
			'view/theme/mango/assets/img/elements/table/pagination/active.png',
			'view/theme/mango/assets/img/elements/table/pagination/disabled.png',
			'view/theme/mango/assets/img/elements/table/pagination/hover.png',
			'view/theme/mango/assets/img/elements/table/toolbar/hover.png',
			'view/theme/mango/assets/img/elements/table/sorting-asc.png',
			'view/theme/mango/assets/img/elements/table/sorting-desc.png',
			'view/theme/mango/assets/img/elements/table/sorting.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/tags/bg.png',
			'view/theme/mango/assets/img/elements/tags/left.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/to-top/active.png',
			'view/theme/mango/assets/img/elements/to-top/hover.png',
			'view/theme/mango/assets/img/elements/to-top/normal.png'
		]);

		mango.utils.preload(['view/theme/mango/assets/img/elements/tooltips/bg.png']);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/upload/bg-hover.png',
			'view/theme/mango/assets/img/elements/upload/bg-normal.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/elements/wizard/arrow-current.png',
			'view/theme/mango/assets/img/elements/wizard/arrow-error.png',
			'view/theme/mango/assets/img/elements/wizard/arrow-normal.png',
			'view/theme/mango/assets/img/elements/wizard/arrow-success.png',
			'view/theme/mango/assets/img/elements/wizard/bg-current.png',
			'view/theme/mango/assets/img/elements/wizard/bg-error.png',
			'view/theme/mango/assets/img/elements/wizard/bg-normal.png',
			'view/theme/mango/assets/img/elements/wizard/bg-success.png',
			'view/theme/mango/assets/img/elements/wizard/bg.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/external/chosen-sprite.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/external/colorpicker/blank.gif',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_background.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_hex.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_hsb_b.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_hsb_h.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_hsb_s.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_indic.gif',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_overlay.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_rgb_b.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_rgb_g.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_rgb_r.png',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_select.gif',
			'view/theme/mango/assets/img/external/colorpicker/colorpicker_submit.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_background.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_hex.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_hsb_b.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_hsb_h.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_hsb_s.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_indic.gif',
			'view/theme/mango/assets/img/external/colorpicker/custom_rgb_b.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_rgb_g.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_rgb_r.png',
			'view/theme/mango/assets/img/external/colorpicker/custom_submit.png',
			'view/theme/mango/assets/img/external/colorpicker/select.png',
			'view/theme/mango/assets/img/external/colorpicker/select2.png',
			'view/theme/mango/assets/img/external/colorpicker/slider.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/external/editor/buttons.gif',
			'view/theme/mango/assets/img/external/editor/toolbar.gif'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/external/explorer/arrows-active.png',
			'view/theme/mango/assets/img/external/explorer/arrows-normal.png',
			'view/theme/mango/assets/img/external/explorer/crop.gif',
			'view/theme/mango/assets/img/external/explorer/dialogs.png',
			'view/theme/mango/assets/img/external/explorer/icons-big.png',
			'view/theme/mango/assets/img/external/explorer/icons-small.png',
			'view/theme/mango/assets/img/external/explorer/logo.png',
			'view/theme/mango/assets/img/external/explorer/progress.gif',
			'view/theme/mango/assets/img/external/explorer/quicklook-bg.png',
			'view/theme/mango/assets/img/external/explorer/quicklook-icons.png',
			'view/theme/mango/assets/img/external/explorer/resize.png',
			'view/theme/mango/assets/img/external/explorer/spinner-mini.gif',
			'view/theme/mango/assets/img/external/explorer/toolbar.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/external/gallery/blank.gif',
			'view/theme/mango/assets/img/external/gallery/fancybox_buttons.png',
			'view/theme/mango/assets/img/external/gallery/fancybox_loading.gif',
			'view/theme/mango/assets/img/external/gallery/fancybox_sprite.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_flat_0_000000_40x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_flat_30_000000_40x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_flat_65_e3e3e3_40x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_flat_75_ffffff_40x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_glass_55_fbf9ee_1x400.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_highlight-hard_100_f0f0f0_1x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_highlight-soft_100_e8e8e8_1x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_highlight-soft_75_b3bfcb_1x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-bg_inset-soft_95_fef1ec_1x100.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-icons_222222_256x240.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-icons_2e83ff_256x240.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-icons_3a4450_256x240.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-icons_454545_256x240.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-icons_888888_256x240.png',
			'view/theme/mango/assets/img/external/jquery-ui/ui-icons_cd0a0a_256x240.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/external/uploader/backgrounds.gif',
			'view/theme/mango/assets/img/external/uploader/buttons-disabled.png',
			'view/theme/mango/assets/img/external/uploader/buttons.png',
			'view/theme/mango/assets/img/external/uploader/delete.gif',
			'view/theme/mango/assets/img/external/uploader/done.gif',
			'view/theme/mango/assets/img/external/uploader/error.gif',
			'view/theme/mango/assets/img/external/uploader/throbber.gif',
			'view/theme/mango/assets/img/external/uploader/transp50.png'
		]);

		mango.utils.preload([
			'view/theme/mango/assets/img/jquery-ui/accordion-header-active.png',
			'view/theme/mango/assets/img/jquery-ui/accordion-header-hover.png',
			'view/theme/mango/assets/img/jquery-ui/accordion-header.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/arrow-left.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/arrow-right.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/button-bg.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/button-hover-bg.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/button-seperator.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/day-current.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/day-hover.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/days-of-week-bg.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/header-bg.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/time-bg.png',
			'view/theme/mango/assets/img/jquery-ui/datepicker/top-arrow.png',
			'view/theme/mango/assets/img/jquery-ui/dialog-titlebar-close-hover.png',
			'view/theme/mango/assets/img/jquery-ui/dialog-titlebar.png',
			'view/theme/mango/assets/img/jquery-ui/loading.gif',
			'view/theme/mango/assets/img/jquery-ui/progressbar/bg.png',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-blue-small.png',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-blue.gif',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-blue.png',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-grey.gif',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-grey.png',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-orange-small.png',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-orange.gif',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-orange.png',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-red-small.png',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-red.gif',
			'view/theme/mango/assets/img/jquery-ui/progressbar/fill-red.png',
			'view/theme/mango/assets/img/jquery-ui/slider/bg-range.png',
			'view/theme/mango/assets/img/jquery-ui/slider/bg.png',
			'view/theme/mango/assets/img/jquery-ui/slider/disabled-bg-range.png',
			'view/theme/mango/assets/img/jquery-ui/slider/disabled-bg.png',
			'view/theme/mango/assets/img/jquery-ui/slider/disabled-picker.png',
			'view/theme/mango/assets/img/jquery-ui/slider/disabled-vertical-bg-range.png',
			'view/theme/mango/assets/img/jquery-ui/slider/disabled-vertical-bg.png',
			'view/theme/mango/assets/img/jquery-ui/slider/disabled-vertical-picker.png',
			'view/theme/mango/assets/img/jquery-ui/slider/picker.png',
			'view/theme/mango/assets/img/jquery-ui/slider/vertical-bg-range.png',
			'view/theme/mango/assets/img/jquery-ui/slider/vertical-bg.png',
			'view/theme/mango/assets/img/jquery-ui/slider/vertical-picker.png'
		]);
