            ...
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <div class="box-content">
                        ...
                        <?php } ?>
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal form-column  form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a onclick="$(this).parent().find(':checkbox').prop('checked', true);" style="cursor: pointer"><?php echo $text_select_all; ?></a> / <a onclick="$(this).parent().find(':checkbox').prop('checked', false);" style="cursor: pointer"><?php echo $text_unselect_all; ?></a></div>
                            </div>
                            <div class="form-group">
