                        ...
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-merchant" class="form-horizontal">
                            ...
                            <div class="col-sm-2">
                                <ul class="nav nav-pills nav-stacked" id="address">
                                    <li class="active"><a href="#tab-merchant" data-toggle="tab"><?php echo $tab_general; ?></a></li>
                                    <?php $address_row = 1; ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-merchant-group"><?php echo $entry_merchant_group; ?></label>
                                <div class="col-sm-10">
                                    <select name="merchant_group_id" id="input-merchant-group" class="form-control">
                                        <?php foreach ($merchant_groups as $merchant_group) { ?>
                                        <?php if ($merchant_group['merchant_group_id'] == $merchant_group_id) { ?>
...
<script type="text/javascript"><!--
    $('select[name=\'merchant_group_id\']').on('change', function() {
        $.ajax({
            url: 'index.php?route=account/merchant/customfield&token=<?php echo $token; ?>&merchant_group_id=' + this.value,
            dataType: 'json',
    ...
    $('select[name=\'merchant_group_id\']').trigger('change');
    //--></script>
<script type="text/javascript"><!--
...
<script type="text/javascript"><!--
    function country(element, index, zone_id) {
        if (element.value != '') {
            $.ajax({
                url: 'index.php?route=account/merchant/country&token=<?php echo $token; ?>&country_id=' + element.value,
                dataType: 'json',
                beforeSend: function() {
...
<script type="text/javascript"><!--
    ...
    $('#history').load('index.php?route=account/merchant/history&token=<?php echo $token; ?>&merchant_id=<?php echo $merchant_id; ?>');

    $('#button-history').on('click', function(e) {
        e.preventDefault();

        $.ajax({
            url: 'index.php?route=account/merchant/history&token=<?php echo $token; ?>&merchant_id=<?php echo $merchant_id; ?>',
            type: 'post',
            dataType: 'html',
...
<script type="text/javascript"><!--
    ...
    $('#transaction').load('index.php?route=account/merchant/transaction&token=<?php echo $token; ?>&merchant_id=<?php echo $merchant_id; ?>');

    $('#button-transaction').on('click', function(e) {
        e.preventDefault();

        $.ajax({
            url: 'index.php?route=account/merchant/transaction&token=<?php echo $token; ?>&merchant_id=<?php echo $merchant_id; ?>',
            type: 'post',
            dataType: 'html',
...
<script type="text/javascript"><!--
    ...
    $('#reward').load('index.php?route=account/merchant/reward&token=<?php echo $token; ?>&merchant_id=<?php echo $merchant_id; ?>');

    $('#button-reward').on('click', function(e) {
        e.preventDefault();

        $.ajax({
            url: 'index.php?route=account/merchant/reward&token=<?php echo $token; ?>&merchant_id=<?php echo $merchant_id; ?>',
            type: 'post',
            dataType: 'html',
    ...
    $('#ip').load('index.php?route=account/merchant/ip&token=<?php echo $token; ?>&merchant_id=<?php echo $merchant_id; ?>');

    $('body').delegate('.button-ban-add', 'click', function() {
        var element = this;

        $.ajax({
            url: 'index.php?route=account/merchant/addbanip&token=<?php echo $token; ?>',
            type: 'post',
            dataType: 'json',
            ...
            success: function(json) {
                ...
                if (json['error']) {
                    $('#main > .container-fluid').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '</div>');

                    $('.alert').fadeIn('slow');
                }

                if (json['success']) {
                    $('#main > .container-fluid').prepend('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + '</div>');
    ...
    $('body').delegate('.button-ban-remove', 'click', function() {
        ...
        $.ajax({
            url: 'index.php?route=account/merchant/removebanip&token=<?php echo $token; ?>',
            type: 'post',
            dataType: 'json',
            data: 'ip=' + encodeURIComponent(this.value),
            beforeSend: function() {
    ...
    $('#main').delegate('button[id^=\'button-custom-field\'], button[id^=\'button-address\']', 'click', function() {
        var node = this;
