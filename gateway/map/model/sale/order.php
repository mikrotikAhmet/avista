...
class ModelSaleOrder extends Model {
    ...
    public function getTotalOrdersByApplicationId($application_id) {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` WHERE application_id = '" . (int)$application_id . "'");
