...
class ModelAccountCustomField extends Model {
    public function addCustomField($data) {
        ...
        if (isset($data['custom_field_merchant_group'])) {
            foreach ($data['custom_field_merchant_group'] as $custom_field_merchant_group) {
                if (isset($custom_field_merchant_group['merchant_group_id'])) {
                    $this->db->query("INSERT INTO " . DB_PREFIX . "custom_field_merchant_group SET custom_field_id = '" . (int)$custom_field_id . "', merchant_group_id = '" . (int)$custom_field_merchant_group['merchant_group_id'] . "', required = '" . (int)(isset($custom_field_merchant_group['required']) ? 1 : 0) . "'");
                }
            }
        }
    ...
    public function editCustomField($custom_field_id, $data) {
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "custom_field_merchant_group WHERE custom_field_id = '" . (int)$custom_field_id . "'");
    ...
    public function getCustomFields($data = array()) {
        if (empty($data['filter_merchant_group_id'])) {
            ...
            $sql = "SELECT * FROM " . DB_PREFIX . "custom_field_merchant_group cfcg LEFT JOIN `" . DB_PREFIX . "custom_field` cf ON (cfcg.custom_field_id = cf.custom_field_id) LEFT JOIN " . DB_PREFIX . "custom_field_description cfd ON (cf.custom_field_id = cfd.custom_field_id) WHERE cfd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
        }
        ...
        if (!empty($data['filter_merchant_group_id'])) {
            $sql .= " AND cfcg.merchant_group_id = '" . (int)$data['filter_merchant_group_id'] . "'";
        }
    ...
    public function getCustomFieldCustomerGroups($custom_field_id) {
        $query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "custom_field_merchant_group` WHERE custom_field_id = '" . (int)$custom_field_id . "'");
