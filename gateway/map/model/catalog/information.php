...
class ModelCatalogInformation extends Model {
    public function addInformation($data) {
        ...
        if (isset($data['information_application'])) {
            foreach ($data['information_application'] as $application_id) {
                $this->db->query("INSERT INTO " . DB_PREFIX . "information_to_application SET information_id = '" . (int)$information_id . "', application_id = '" . (int)$application_id . "'");
            }
        }

        if (isset($data['information_layout'])) {
            foreach ($data['information_layout'] as $application_id => $layout_id) {
                $this->db->query("INSERT INTO " . DB_PREFIX . "information_to_layout SET information_id = '" . (int)$information_id . "', application_id = '" . (int)$application_id . "', layout_id = '" . (int)$layout_id . "'");
            }
        }
    ...
    public function editInformation($information_id, $data) {
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "information_to_application WHERE information_id = '" . (int)$information_id . "'");
    ...
    public function getInformationApplications($information_id) {
        $information_application_data = array();

        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "information_to_application WHERE information_id = '" . (int)$information_id . "'");

        foreach ($query->rows as $result) {
            $information_application_data[] = $result['application_id'];
        }

        return $information_application_data;
    }
    ...
    public function getInformationLayouts($information_id) {
        ...
        foreach ($query->rows as $result) {
            $information_layout_data[$result['application_id']] = $result['layout_id'];
        }
