...
class ModelSettingApplication extends Model {
    public function addApplication($data) {
        $this->event->trigger('pre.admin.application.add', $data);
        ...
        $this->event->trigger('post.admin.application.add', $application_id);

        return $application_id;
    }

    public function editApplication($application_id, $data) {
        $this->event->trigger('pre.admin.application.edit', $data);
        ...
        $this->event->trigger('post.admin.application.edit', $application_id);
    }

    public function deleteApplication($application_id) {
        $this->event->trigger('pre.admin.application.delete', $application_id);

        $this->db->query("DELETE FROM " . DB_PREFIX . "application WHERE application_id = '" . (int)$application_id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "layout_route WHERE application_id = '" . (int)$application_id . "'");

        $this->cache->delete('application');

        $this->event->trigger('post.admin.application.delete', $application_id);
    }
