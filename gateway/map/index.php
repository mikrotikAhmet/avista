...
// Configuration
if (file_exists(APPLICATION_PATH_COR . 'map/config.php')) {
    require_once(APPLICATION_PATH_COR . 'map/config.php');
} else {
    exit('Configuration file can not be located!');
}
...
if (file_exists(DIR_SYSTEM . 'startup.php')) {
    ...
    exit('Startup file can not be located!');
}
