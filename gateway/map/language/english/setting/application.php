...
// Help
$_['help_url']                         = 'Include the full URL to your application. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new application. You should always point another domain or sub domain to your hosting.';
$_['help_ssl']                         = 'SSL URL to your application. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new application. You should always point another domain or sub domain to your hosting.';
$_['help_geocode']                     = 'Please enter your application location geocode manually.';
$_['help_open']                        = 'Fill in your applications opening times.';
...
$_['help_tax_default']                 = 'Use the application address to calculate taxes if no one is logged in. You can choose to use the application address for the customers shipping or payment address.';
