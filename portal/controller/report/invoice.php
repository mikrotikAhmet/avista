...
class ControllerReportInvoice extends Controller {
	...
	public function index(){
		...
		$order_total = $this->model_account_order->getTotalOrdersByInvoice($filter_data);

		$results = $this->model_account_order->getInvoices($filter_data);
		...
		$data['sort_order'] = $this->url->link('account/invoice', '' . '&sort=o.order_id' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('account/invoice', '' . '&sort=status' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('account/invoice', '' . '&sort=o.total' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('account/invoice', '' . '&sort=o.date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('account/invoice', '' . '&sort=o.date_modified' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('account/invoice', '' . $url . '&page={page}', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/report/invoice.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/report/invoice.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/report/invoice.tpl', $data));
		}
	}
