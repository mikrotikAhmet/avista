...
class ControllerReportContract extends Controller {
	...
	public function index(){
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/contract', '', 'SSL'),
		...
		$order_total = $this->model_account_order->getTotalOrdersByContract($filter_data);

		$results = $this->model_account_order->getContracts($filter_data);
		...
		$data['sort_order'] = $this->url->link('account/contract', '' . '&sort=o.order_id' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('account/contract', '' . '&sort=status' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('account/contract', '' . '&sort=o.total' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('account/contract', '' . '&sort=o.date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('account/contract', '' . '&sort=o.date_modified' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('account/contract', '' . $url . '&page={page}', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/report/contract.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/report/contract.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/report/contract.tpl', $data));
		}
	}
