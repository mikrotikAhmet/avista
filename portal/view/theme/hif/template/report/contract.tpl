                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p><span class="text-success"><b>Issued</b></span> means, you have ISSUED CONTRACT. You can safely view and print your contract.<br/>
                            After  singing the contract please go to : <b>My Documents section and upload your contract. </p>
                        <div class="well">
                            <div class="row">
                                <div class="col-sm-4">
...
<script type="text/javascript"><!--
    $('#button-refresh').on('click', function() {
        url = 'index.php?route=report/contract';
...
//
        $.ajax({
            url: 'index.php?route=report/order/getOrder',
            type: 'post',
