...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <div class="container">
            <button class="btn btn-link pull-right" onclick="myFunction()">Invoice ID :<?php echo strtoupper($order['invoice_no'])?></button>
            <ul style="list-style: none">
                ...
                <li>08. BUSINESS AGREEMENT / CONTRACT ISSUED DATE:<b><?php echo strtoupper($contract['date_added'])?></b><li/>
