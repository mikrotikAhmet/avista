...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <div class="container">
        <button class="btn btn-link pull-right" onclick="myFunction()">Print Contract ID <?php echo strtoupper($contract['contract_id'])?></button>
            <ul style="list-style: none">
                ...
                <li>3.1.4. MATURITY DATE OF INSTRUMENT:<b><?php echo date("Y/m/d",strtotime($contract['maturity_date']))?></b></li>
